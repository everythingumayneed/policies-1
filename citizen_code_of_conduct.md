...
A primary goal of [CalliTechDev](https://github.com/CalliTechDev) is to be inclusive to the largest number of contributors, with the most varied and diverse backgrounds possible. As such, we are committed to providing a friendly, safe and welcoming environment for all, regardless of gender, sexual orientation, ability, ethnicity, socioeconomic status, and religion (or lack thereof).

This code of conduct outlines our expectations for all those who participate in our community, as well as the consequences for unacceptable behavior.

We invite all those who participate in [CalliTechDev](https://github.com/CalliTechDev) to help us create safe and positive experiences for everyone.
...
[dev@calli.tech](dev@calli.tech)

[Reporting Guidelines](https://github.com/CalliTechDev/policies/blob/master/reporting_guidelines.md)
...
[Policies](https://github.com/CalliTechDev/policies/blob/master/README.md)
...
[http://calli.tech/](http://calli.tech/)
